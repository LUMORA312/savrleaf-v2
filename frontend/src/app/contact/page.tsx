        ...
        <main className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
          <div className="max-w-md w-full bg-white rounded-xl shadow-md p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Thank you for contacting SavrLeaf<sup class="text-xs align-super">®</sup>. We&apos;ll respond within 24–48 hours.
            </p>
            <Link
              href="/"
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <header className="mb-10 text-center">
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">
              Contact SavrLeaf<sup class="text-xs align-super">®</sup>
            </h1>
