    ...
    <footer className="bg-gradient-to-b from-green-950 via-green-950 to-gray-800 text-white font-sans mt-auto">
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-10">
        ...
        <div className="bg-yellow-950 border border-yellow-700 rounded-xl p-5 shadow-md">
          <div className="flex items-start gap-4">
            ...
            <div className="text-sm leading-relaxed text-yellow-100">
              ...
              <p>
                <strong className="text-yellow-50"><sup class="text-xs align-super">®</sup> does not sell or handle cannabis products.</strong> We connect consumers with licensed dispensaries. All purchases are made through licensed third-party retailers. Please consume responsibly and follow local laws.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              />
              <h2 className="text-2xl font-bold text-white"><sup class="text-xs align-super">®</sup></h2>
            </div>
        ...
        <div className="border-t border-green-800 pt-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 text-sm text-gray-400">
          <div>
            <p>© 2025 SavrLeaf<sup class="text-xs align-super">®</sup>. All rights reserved.</p>
            <p className="text-xs mt-1">
              SavrLeaf<sup class="text-xs align-super">®</sup> is a registered trademark of LumoraSolutionsLLC. Product names and logos are property of their respective owners.
            </p>
          </div>
